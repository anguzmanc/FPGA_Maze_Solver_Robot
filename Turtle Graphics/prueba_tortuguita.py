...
with open('/Users/andresguzman/Library/CloudStorage/GoogleDrive-anguzmanc@unal.edu.co/Otras computadoras/Mi PC/Semestre VIII/Electronica Digital II/Laboratorio/Proyecto Lab/Pruebas Python/Trayecto.txt', 'r') as archivo:
